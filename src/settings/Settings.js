...
export const WEAKEN_TIME_CUTOFF_HACK_LEVEL_INCREMENTS = 500; //Every X hacking level cutoff time increases

export const TIME_BETWEEN_ATTACK_PHASES = 200;
...
export const SLEEVE_SHOCK_THRESHOLD = 97;

export const GANG_BASE_COMBAT_TRAINING_THRESHOLD = 125;
export const GANG_COMBAT_TRAINING_THRESHOLD = 1000;
export const GANG_BASE_HACKING_TRAINING_THRESHOLD = 25;
export const GANG_BASE_CHARISMA_TRAINING_THRESHOLD = 25;

export const GANG_MIN_NUM_OF_AUGMENTS_TO_BUY = 6;