...
import {SERVER_NAME_JOESGUNS, SERVER_NAME_SIGMA_COSMETICS} from "/constants/ServerNames";
...
export const ALLOWED_HASHNET_TARGETS = [
    SERVER_NAME_JOESGUNS,
    SERVER_NAME_SIGMA_COSMETICS,
...
export const SLEEVE_SHOCK_THRESHOLD = 90;