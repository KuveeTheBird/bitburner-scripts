...
export const FACTIONS_HACKING_STAT_REQUIREMENTS = {
    [FACTION_NAME_CYBERSEC]: 54,
    [FACTION_NAME_NITESEC]: 209,
    [FACTION_NAME_THE_BLACK_HAND]: 363,
    [FACTION_NAME_BITRUNNERS]: 550,
...
export const FACTIONS_REP_THRESHOLDS = {
    ...
    [FACTION_NAME_NITESEC]: [10000, 20000, 50000],
    [FACTION_NAME_SECTOR_12]: [25000],
    [FACTION_NAME_CHONGQING]: [10000, 25000, 50000, 100000], //TODO: CHECK
    [FACTION_NAME_NEW_TOKYO]: [10000, 25000, 50000, 100000], //TODO: CHECK
    [FACTION_NAME_ISHIMA]: [10000, 25000, 50000, 100000], //TODO: CHECK
    [FACTION_NAME_THE_BLACK_HAND]: [50000, 100000],
    [FACTION_NAME_BITRUNNERS]: [100000, 200000],
    [FACTION_NAME_VOLHAVEN]: [10000, 25000, 50000, 100000], //TODO: CHECK

    [FACTION_NAME_DAEDALUS]: [10000, 25000, 50000, 100000], //TODO: CHECK
    [FACTION_NAME_SLUM_SNAKES]: [7500],
    [FACTION_NAME_TETRADS]: [10000, 25000, 50000, 100000], //TODO: CHECK
    [FACTION_NAME_THE_SYNDICATE]: [10000, 25000, 50000, 100000], //TODO: CHECK
    [FACTION_NAME_AEVUM]: [10000, 25000, 50000, 100000], //TODO: CHECK
    [FACTION_NAME_SPEAKERS_FOR_THE_DEAD]: [10000, 25000, 50000, 100000], //TODO: CHECK
    [FACTION_NAME_THE_DARK_ARMY]: [10000, 25000, 50000, 100000], //TODO: CHECK

    [FACTION_NAME_THE_COVENANT]: [10000, 25000, 50000, 100000], //TODO: CHECK
    [FACTION_NAME_ILLUMINATI]: [10000, 25000, 50000, 100000], //TODO: CHECK
};
